...
from zenml import Model, pipeline, step, get_step_context, ArtifactConfig
...
def promote_model(
    ...
    if rmse < previous_production_rmse:
        ...
        logger.info(f"Model not promoted. Current RMSE ({rmse}) is not better than production RMSE ({previous_production_rmse})")
        return False
